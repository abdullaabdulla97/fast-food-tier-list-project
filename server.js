...
app.get('/register', routes.registerPage) // when a user goes to /register, it will then display the register page
app.post('/register', routes.register) // when a user submits the register form, it will then call the register function to register the user (JSON data is sent)
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`http://localhost:${PORT}/register`) // logs the URL for testing the register page
})
